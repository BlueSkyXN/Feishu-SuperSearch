...
| `github.com/ncruces/go-strftime` | `v1.0.0` | MIT | `LICENSES/runtime/go-ncruces-go-strftime.txt` |
...
| `golang.org/x/sys` | `v0.46.0` | BSD-3-Clause | `LICENSES/runtime/go-golang-x-sys.txt` |
| `golang.org/x/text` | `v0.14.0` | BSD-3-Clause | `LICENSES/runtime/go-golang-x-text.txt` |
| `modernc.org/libc` | `v1.74.1` | BSD-3-Clause AND MIT | `LICENSES/runtime/go-modernc-libc*.txt` |
| `honnef.co/go/netdb`（由 `modernc.org/libc` 内嵌） | bundled in `v1.74.1` | MIT | `LICENSES/runtime/go-modernc-libc-honnef-netdb.txt` |
...
| `modernc.org/sqlite` | `v1.55.0` | BSD-3-Clause | `LICENSES/runtime/go-modernc-sqlite.txt` |

## Embedded Web production packages

| Component | Version | License | Notice |
|---|---|---|---|
| `react` | `19.2.8` | MIT | `LICENSES/runtime/npm-react-family.txt` |
| `react-dom` | `19.2.8` | MIT | `LICENSES/runtime/npm-react-family.txt` |
| `scheduler` | `0.27.0` | MIT | `LICENSES/runtime/npm-react-family.txt` |
